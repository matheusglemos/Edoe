...
/**
 * Classe que irá representar uma doação entre um usuario doador e um usuario
...
public class Doacao {
	...
	/**
	 * Atributo em String que representa a data de uam doação
	 */
	private String data;
	...
	/**
	 * Construtor da classe doação
	 * @param data
	 * @param itemDoado
	 * @param itemNecessario
	 * @param totalDoado
	 */
	public Doacao(String data, Item itemDoado, ItemNecessario itemNecessario, int totalDoado) {
	...
	/**
	 * Representação textual da classe doação
	 */
	@Override
	public String toString() {
		return this.getData() + "- doador:" + this.getItemDoado().nomeDoador() + "/" + this.getItemDoado().idDoador()
				+ ",item:" + this.getItemDoado().getDescricao() + ",quantidade:" + this.getItemDoado().getQuantidade()
				+ ",receptor:" + this.getItemNecessario().nomeReceptor() + "/" + this.getItemNecessario().idReceptor();
	}
